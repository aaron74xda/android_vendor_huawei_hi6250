...
LOCAL_SRC_FILES := VoiceMatch/HotwordEnrollmentOKGoogleHI6403.apk
...
LOCAL_MODULE_OWNER := honor
LOCAL_SRC_FILES := VoiceMatch/HotwordEnrollmentXGoogleHI6403.apk
LOCAL_CERTIFICATE := PRESIGNED
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_CLASS := APPS
LOCAL_MODULE_SUFFIX := $(COMMON_ANDROID_PACKAGE_SUFFIX)
...
LOCAL_MODULE := NfcNci
LOCAL_MODULE_OWNER := honor
LOCAL_SRC_FILES := Nfc/NfcNci.apk
